...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
         it('should have defined name', function() {
            for (var feed = 0; feed < allFeeds.length; feed++){
    ...
    describe('New Feed Selection', function() {
        ...
        it(' should changes its content when a newfeed is loaded', function(done) {
            var beforeFeed = $('.header-title');
            loadFeed(1);
            var AfterFeed = $('.header-title');
